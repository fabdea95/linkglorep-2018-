YUI.add('moodle-atto_linkglorep-button', function (Y, NAME) {
...
var TEMPLATE = '' +
    '<form class="atto_form">' +
        '<div id="{{elementid}}_{{innerform}}" class="mdl-align">' +
            '<label for="{{elementid}}_{{KEYCONTROL}}">Inserire keyword per la ricerca in GLorep</label>' +
...
Y.namespace('M.atto_linkglorep').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _doInsert : function(e){
       ...
       /* if (!keycontrol.get('value')){
        ...
        this.editor.focus();
        this.get('host').insertContentAtFocusPoint('<html><head><a href="'+ url +'">trova repository per approfondire</a><br></head></html>');
        //var prova = this._form.one(SELECTORS.KEYCONTROL);
